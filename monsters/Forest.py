...
mosskin_warrior_floor_range = (2, 4)
...
mosskin_ranger_floor_range = (2, 4)
...
carnivorous_plant_floor_range = (4, 6)
...
poison_dandelion_floor_range = (5, 8)
...
mosskin_shaman_floor_range = (6, 8)
...
mosskin_sentinel_floor_range = (6, 8)
...
mosskin_sporecaster_floor_range = (7, 9)
...
mosskin_berserker_floor_range = (7, 9)
...
mosskin_thornweaver_floor_range = (8, 10)
...
mosskin_giant_gear = ["Massive Club", "Heavy Armor"]
mosskin_giant_loot_table = ["Gold", "Giant Tooth", "Giant Club"]
mosskin_giant_description = "Mosskin Giants are colossal beings towering over the landscape with brute strength and raw power. They wield massive clubs and hurl boulders at their foes, crushing anything that stands in their way. Their sheer size and ferocity make them a force to be reckoned with."
mosskin_giant_floor_range = (8, 10)
mosskin_giant_spells = []
mosskin_giant_spell_probabilities = {}
mosskin_giant_initial_stats = mosskin_giant_stats.copy() # Make a copy of the initial stats
mosskin_giant = Monster("Mosskin Giant", mosskin_giant_stats, mosskin_giant_gear, mosskin_giant_loot_table, difficulty=40, description=mosskin_giant_description, floor_range=mosskin_giant_floor_range, spells=mosskin_giant_spells, spell_probabilities=mosskin_giant_spell_probabilities, initial_stats=mosskin_giant_initial_stats)
...
grove_howler_floor_range = (11, 13)
grove_howler_spells = []
...
grove_guardian_floor_range = (11, 13)
...
grove_spirit_floor_range = (11, 13)
...
grove_warden_floor_range = (12, 15)
grove_warden_spells = []
...
grove_symbiote_floor_range = (12, 15)
...
awakened_tree_floor_range = (12, 15)
...
grove_goliath_floor_range = (13, 16)
