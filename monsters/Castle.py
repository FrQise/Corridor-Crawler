...
sinister_squire_floor_range = (1, 2)
...
cursed_courtesan_floor_range = (2, 3)
...
castle_conscript_floor_range = (2, 3)
...
apparition_archer_floor_range = (2, 4)
...
nightshade_stalker_floor_range = (4, 6)  # Nightshade Stalker appears on floors 19 to 21
...
ironclad_sentinel_floor_range = (4, 6)
...
ironbound_infantry_floor_range = (4, 6)
...
haunter_herald_floor_range = (5, 7)
...
slithering_hoard_floor_range = (5, 7)
...
enchanted_armor_floor_range = (5, 8)
...
darkmage_acolyte_floor_range = (6, 8)
...
ghostly_guardsman_floor_range = (6, 8)  # Ghostly Guardsman appears on floors 12 to 15
...
gargoyle_sentinel_floor_range = (6, 8)
...
darkmage_channeler_floor_range = (7, 9)
...
bandit_marauder_floor_range = (7, 9)
...
knightly_bannerman_floor_range = (7, 9)
...
werewolf_loot_table = {"Gold":(1, 10), "Longsword":(0.2,1), "Random_item":(0.5,1)}
...
bloodhound_jailer_floor_range = (8, 10)
...
bloodhound_gear = ["Iron Whip", "Chainmail Armor"]
bloodhound_loot_table = ["Jailer's Key", "Bloodhound Collar", "Rusty Shackles"]
bloodhound_description = "Chieng de sang"
bloodhound_floor_range = (8, 10)
bloodhound_spells = []
bloodhound_spell_probabilities = {}
bloodhound_initial_stats = bloodhound_jailer_stats.copy()
bloodhound = Monster("Bloodhound", bloodhound_jailer_stats, bloodhound_jailer_gear, bloodhound_jailer_loot_table, difficulty=8, description=bloodhound_jailer_description, floor_range=bloodhound_jailer_floor_range, spells=bloodhound_jailer_spells, spell_probabilities=bloodhound_jailer_spell_probabilities, initial_stats=bloodhound_jailer_initial_stats)
...
ironbound_legionnaire_floor_range = (9, 11)
...
stoneguard_knight_floor_range = (10, 12)
...
spectral_knight_floor_range = (10, 12)
...
blacksteel_brute_floor_range = (10, 12)
...
cursed_captain_floor_range = (11, 13)
...
ironclad_golem_floor_range = (12, 15)
...
castle_crusader_floor_range = (12, 15)
...
blacksteel_brute_loot_table = ["Blacksteel Shard", "Dark Essence", "Brutal Trophy"]
blacksteel_brute_description = "The Blacksteel Brute is a fearsome adversary, wielding a massive greatsword forged from dark steel. Its imposing figure and relentless strength make it a formidable opponent in battle."
blacksteel_brute_floor_range = (12, 15)
...
armored_arbiter_floor_range = (13, 16)
...
citadel_champion_floor_range = (13, 16)
...
citadel_crusader_floor_range = (14, 17)
...
royal_guardsman_floor_range = (14, 17)
...
deaths_head_tree_floor_range = (15, 18)
...
helmed_horror_floor_range = (15, 18)
...
knight_of_the_keep_floor_range = (17, 19)
...
royal_guardsman_floor_range = (17, 19)
royal_guardsman_spells = []
royal_guardsman_spell_probabilities = {}
royal_guardsman_initial_stats = royal_guardsman_stats.copy()
royal_guardsman = Monster("Royal Guardsman", royal_guardsman_stats, royal_guardsman_gear, royal_guardsman_loot_table, difficulty=9, description=royal_guardsman_description, floor_range=royal_guardsman_floor_range, spells=royal_guardsman_spells, spell_probabilities=royal_guardsman_spell_probabilities, initial_stats=royal_guardsman_initial_stats)