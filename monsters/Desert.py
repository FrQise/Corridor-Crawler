...
dust_wraith_gear = ["Sandslash Whirlwind", "Turbulent Essence"]
dust_wraith_loot_table = ["Gold", "Dust Particle", "Whirlwind Fragment"]
dust_wraith_description = "Dust wraiths are malevolent spirits that inhabit the swirling sandstorms of the desert. They can tear through flesh with their razor-sharp winds, leaving nothing but devastation in their wake. Beware their wrath, for they spare no mercy for those who dare to trespass in their domain."
dust_wraith_floor_range = (1, 2)
dust_wraith_spells = []
dust_wraith_spell_probabilities = {}
dust_wraith_initial_stats = dust_wraith_stats.copy()
dust_wraith = Monster("Dust Wraith", dust_wraith_stats, dust_wraith_gear, dust_wraith_loot_table, difficulty=150, description=dust_wraith_description, floor_range=dust_wraith_floor_range, spells=dust_wraith_spells, spell_probabilities=dust_wraith_spell_probabilities, initial_stats=dust_wraith_initial_stats)
...
sandswept_sylph_floor_range = (1, 2)
...
sirocco_serpent_floor_range = (1, 3)
...
sandstrider_nomad_floor_range = (2, 4)
...
quicksand_quagmire_floor_range = (4, 6)
...
nomad_camel_rider_floor_range = (5, 8)
...
sand_devil_gear = ["Ethereal Scimitar", "Shifting Sands Cloak"]
sand_devil_loot_table = ["Gold", "devil Essence", "Sands of Eternity"]
sand_devil_description = "Sand devils are spectral beings that haunt the desolate wastelands of the desert. They drift through the dunes, striking fear into the hearts of travelers with their eerie presence. Beware their otherworldly powers, for they can drain the life force from their victims with a touch."
sand_devil_floor_range = (7, 9)
sand_devil_spells = []
sand_devil_spell_probabilities = {}
sand_devil_initial_stats = sand_devil_stats.copy()
sand_devil = Monster("Sand devil", sand_devil_stats, sand_devil_gear, sand_devil_loot_table, difficulty=200, description=sand_devil_description, floor_range=sand_devil_floor_range, spells=sand_devil_spells, spell_probabilities=sand_devil_spell_probabilities, initial_stats=sand_devil_initial_stats)
...
scalding_salamander_floor_range = (7, 9)
...
sandstone_gargoyle_floor_range = (8, 10)
...
sand_elemental_floor_range = (8, 10)
...
sandstalker_scorpion_floor_range = (8, 10)
...
sandstorm_siren_floor_range = (9, 11)
...
sandstorm_elemental_floor_range = (9, 11)
...
cactus_colossus_floor_range = (14, 17)
...
mirage_marauder_floor_range = (14, 17)
...
desert_basilisk_floor_range = (15, 18)
...
oasis_guardian_floor_range = (15, 18)
...
sunfire_djinn_floor_range = (17, 19)
...
cactus_behemoth_floor_range = (17, 19)
