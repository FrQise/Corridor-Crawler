...
goblin_thief_gear = ["Dagger", "Leather Armor"]
goblin_thief_loot_table = {"Gold":(1, 10)}
goblin_thief_description = "Thieves are agile and cunning individuals who excel in stealth, lockpicking, and pickpocketing. They use their speed and wit to outmaneuver their opponents and make off with valuable treasures."
goblin_thief_floor_range = (2, 3)
goblin_thief_spells = []
goblin_thief_spell_probabilities = {}
goblin_thief_initial_stats = goblin_thief_stats.copy()
goblin_thief = Monster("Goblin Thief", goblin_thief_stats, goblin_thief_gear, goblin_thief_loot_table, difficulty=80, description=goblin_thief_description, floor_range=goblin_thief_floor_range, spells=goblin_thief_spells, spell_probabilities=goblin_thief_spell_probabilities, initial_stats=goblin_thief_initial_stats)
...
hobgoblin_loot_table = {"Gold":(1, 10)}
...
giant_spider_loot_table = {"Gold":(1, 10)}
...
goblin_shaman_loot_table = {"Gold":(1, 10)}
...
orc_grunt_loot_table = {"Gold":(1, 10)}
...
orc_shaman_loot_table = {"Gold":(1, 10)}
...
orc_berserker_loot_table = {"Gold":(1, 10)}
...
goblin_bat_mage_loot_table = {"Gold":(1, 10)}
...
goblin_bat_mage_floor_range = (6, 8)
...
goblin_tinkerer_loot_table = {"Gold":(1, 10)}
...
goblin_tinkerer_floor_range = (6, 8)
...
goblin_bomber_loot_table = {"Gold":(1, 10)}
...
hobgoblin_sentinel_loot_table = {"Gold":(1, 10)}
...
hobgoblin_sentinel_floor_range = (6, 8)
...
hobgoblin_battlemage_loot_table = {"Gold":(1, 10)}
...
hobgoblin_battlemage_floor_range = (7, 9)
...
goblin_sharpshooter_loot_table = {"Gold":(1, 10)}
...
goblin_sharpshooter_floor_range = (7, 9)
...
goblin_trickster_loot_table = {"Gold":(1, 10)}
...
goblin_trickster_floor_range = (7, 9)
...
hobgoblin_captain_loot_table = {"Gold":(1, 10)}
...
hobgoblin_captain_floor_range = (7, 9)
...
half_orc_legionnaire_loot_table = {"Gold":(1, 10)}
...
half_orc_legionnaire_floor_range = (8, 10)
...
barbarous_bugbear_loot_table = {"Gold":(1, 10)}
...
barbarous_bugbear_floor_range = (8, 10)
...
hobgoblin_warmage_loot_table = {"Gold":(1, 10)}
...
hobgoblin_warmage_floor_range = (8, 10)
...
half_orc_champion_loot_table = {"Gold":(1, 10)}
...
half_orc_champion_floor_range = (8, 10)
...
ogre_mage_loot_table = {"Gold":(1, 10)}
...
ogre_mage_knight_loot_table = {"Gold":(1, 10)}
...
ogre_mage_knight_floor_range = (9, 11)
...
orc_rager_loot_table = {"Gold":(1, 10)}
...
half_orc_commander_loot_table = {"Gold":(1, 10)}
...
half_orc_commander_floor_range = (10, 12)
...
death_plague_orc_loot_table = {"Gold":(1, 10)}
...
death_plague_orc_floor_range = (10, 12)
...
high_orc_archer_loot_table = {"Gold":(1, 10)}
...
high_orc_archer_floor_range = (11, 13)
...
high_orc_berserker_loot_table = {"Gold":(1, 10)}
...
high_orc_berserker_floor_range = (11, 13)
...
cycloptopus_loot_table = {"Gold":(1, 10)}
cycloptopus_description = "A fearsome creature with the body of an octopus and the eye of a cyclops. It lurks in dark underwater caves, ambushing unsuspecting prey with its powerful tentacles and deadly gaze."
cycloptopus_floor_range = (12, 15)
...
troll_berserker_loot_table = {"Gold":(1, 10)}
...
troll_berserker_floor_range = (12, 15)
...
high_orc_skirmisher_loot_table = {"Gold":(1, 10)}
...
high_orc_skirmisher_floor_range = (12, 15)
...
high_orc_firebrand_loot_table = {"Gold":(1, 10)}
...
high_orc_firebrand_floor_range = (13, 16)
...
savage_orc_brute_loot_table = {"Gold":(1, 10)}
...
savage_orc_brute_floor_range = (13, 16)
